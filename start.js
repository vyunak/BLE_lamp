...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/lamp.vyunak.co.ua/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/lamp.vyunak.co.ua/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/lamp.vyunak.co.ua/chain.pem', 'utf8');
